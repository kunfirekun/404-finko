...
<body class="theme-color2 light ltr">
  ...
  <?php  require_once"header.php";?>
    ...
    <?php  require_once"mobile-header.php";?>
    <!-- mobile fix menu end -->
                ...
                <div class="col-xl-3 ">
                    <div class="service-wrap">
                        ...
                        <div class="service-content">
                            <h3 class="mb-2">Customer Supporty</h3>
                            <span class="font-light">24/7 Free support service on orders.</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="service-wrap">
                        ...
                        <div class="service-content">
                            ...
                            <span class="font-light">Free delivery on orders made by 12pm.</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="service-wrap">
                        ...
                        <div class="service-content">
                            ...
                            <span class="font-light">Secure checkout for complete orders. </span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6">
                    <div class="service-wrap">
                        ...
                        <div class="service-content">
                            ...
                            <span class="font-light">30-days money back guarantee policy.</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/front/5.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/5.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="product-details.php" class="font-default">
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/front/6.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/6.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                        <ul>
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/front/7.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/7.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="label-block">
                                        <span class="label label-black">New</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/front/8.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/8.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                        <ul>
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/1.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="label-block">
                                        <span class="label label-black">New</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/3.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                        <ul>
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                <div class="img-wrapper">
                                    ...
                                    <div class="back">
                                        <a href="product-details.php">
                                            <img src="assets/images/fashion/product/back/4.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="cart-wrap">
                                        <ul>
...
<section class="category-section ratio_40" ">
    ...
    <!-- Banner section 3 end -->
     <!-- brand section start -->
     <section class="section-b-space" style="margin-top: 20px; margin-bottom:10px;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="brand-slider">
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/1.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/2.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/3.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/4.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/5.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                <img src="assets/images/brand/6.png" class="img-fluid blur-up lazyload" alt="brand logo">
                            </div>
                        </div>
                        <div>
                            <div class="brand-image">
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="assets/images/fashion/instagram/1.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="assets/images/fashion/instagram/2.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                                        <div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="assets/images/fashion/instagram/3.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                                        <div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="assets/images/fashion/instagram/4.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                                        <div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="assets/images/fashion/instagram/5.jpg" class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                                        <div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="subscribe-details">
                        ...
                        <h6 class="font-light">Subscribe and receive our newsletters to follow the news about offers, discounts
     ...
     //<div class='cookie-bar-section'>
        ...
        // <div class='content'>
           ...
           //  <div class='cookie-buttons'>
               //  <button class='btn btn-solid-default' id='button' onClick='window.location.reload();'>I understand</button>
