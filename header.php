                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        <div class="category-banner">
                                                            <img src="assets/images/electronics/banner/4.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="category-mega-menu">
                                            <li>
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-3">
                                                        <div class="category-banner">
                                                            <img src="assets/images/banner/1.jpg" class="img-fluid blur-up lazyload" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div class="main-navbar">
                            <div id="mainnav">
                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="mega-menu  ratio_40">
                                        <a href="clearance.php" class="nav-link menu-title">
                                            <div class="gradient-title">Clearance Sale</div>
                                        </a>
                    ...
                    <div class="menu-right">
                        <ul>
                            ...
                            <li class="onhover-dropdown">
                                ...
                                <a href="login.php" class="d-block"><i data-feather="user"></i></a>
                                </div>
                                ...
                                <div class="onhover-div">
                                    <div class="cart-menu">
                                        ...
                                        <ul class="custom-scroll">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <img src="assets/images/fashion/product/front/7.jpg" class="img-fluid blur-up lazyload" alt="">
                                                    <div class="media-body">
